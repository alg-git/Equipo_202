...
<h2 data-i18n="p1.2">Movilidad Sustentable (Bicicletas, Transporte Publico, Autos Eléctricos)</h2>
...
fetch('traductor_Movilidad_Sustentable_(Bicicletas,_Transporte_Publico,_Autos_Electricos).json')
...
<h2 data-i18n="p1.3">Movilidad Sustentable </h2>

<p data-i18n="p1.4">La movilidad sustentable se refiere a formas de transporte que minimizan el impacto ambiental, promueven la eficiencia energética y mejoran la calidad de vida urbana.  </p>
           
    <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/bisis.jpeg" width="350"></div>
 
<h2 data-i18n="p1.5"> Bicicletas </h2>
     
<li data-i18n="p1.6"> Cero emisiones, económicas y saludables.    </li>

<li data-i18n="p1.7">Necesitan ciclovías seguras y fomento desde políticas públicas.      </li>

    <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Bicicletas.jpeg" width="350"></div>
 
<h2 data-i18n="p1.8">  Transporte Público </h2>
  
<li data-i18n="p1.9">  Reduce tráfico y contaminación.  </li>
 
<li data-i18n="p1.10">  Requiere mejoras en cobertura, frecuencia y tecnología (buses eléctricos).    </li> 

    <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Transporte_Público.jpeg" width="350"></div>
 
  <h2 data-i18n="p1.11"> Autos Eléctricos</h2>

  <li data-i18n="p1.12">No contaminan al circular y son silenciosos. </li> 

  <li data-i18n="p1.13">Aún son costosos y necesitan más puntos de carga. </li>

     <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Autos_Eléctricos.jpeg" width="350"></div>

 <iframe width="560" height="315" src="https://www.youtube.com/embed/gNoNWpy32js?si=RdUq2ZhQv27G6Irk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
