...
<h1 data-i18n="p4.18">Cuidado del medio ambiente</h1>  
<h2 data-i18n="p4.19"> Manejo adecuado de residuos electronicos peligrosos</h2>
...
<h2 data-i18n="p4.1">¿Qué son los residuos electrónicos peligrosos?</h2><br><br>

<p data-i18n="p4.2">Los residuos electrónicos peligrosos (e-waste) incluyen dispositivos eléctricos y electrónicos desechados que contienen sustancias tóxicas como plomo, mercurio, cadmio, cromo y retardantes de llama. Algunos ejemplos comunes son:</p><br><br>

<li data-i18n="p4.3">Computadoras y laptops</li><br><br>

<li data-i18n="p4.4">Teléfonos móviles</li><br><br>

<li data-i18n="p4.5">Televisores</li><br><br>

<li data-i18n="p4.6">Baterías de litio</li><br><br>

<li data-i18n="p4.7">Impresoras y escáneres</li><br><br>

 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/los_residuos_electrónicos_peligrosos.jpeg" width="350"></div>

<h2 data-i18n="p4.8">¿Por qué son peligrosos?</h2><br><br>

<p data-i18n="p4.9">Porque contienen componentes químicos que contaminan el suelo, el aire y el agua si no se manejan adecuadamente. También pueden afectar la salud humana, provocando enfermedades respiratorias, neurológicas y de la piel.</p><br><br>

 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/por_qué_son_peligrosos_los_residuo_electrónicos_peligrosas.png" width="350"></div>

<h2 data-i18n="p4.10">Pasos para el manejo adecuado:</h2><br><br>

<h4 data-i18n="p4.11">Recolección y clasificación</h4><br><br>

<p data-i18n="p4.12">Separar los residuos electrónicos de la basura doméstica. Clasificarlos por tipo (baterías, computadoras, celulares, etc.).</p><br><br>

 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Recolección_y_clasificación_de_los_residuos_electrónicos_peligrosos.jpeg" width="350"></div>

<h4 data-i18n="p4.13">Reutilización y reparación</h4><br><br>

<p data-i18n="p4.14">Si el equipo aún funciona, se puede donar, revender o reparar para extender su vida útil.</p><br><br>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Reutilización_y_reparación_de_los_residuos_electrónicos_peligrosos.webp" width="350"></div>

<h4 data-i18n="p4.15">Reciclaje especializado</h4><br><br>

<p data-i18n="p4.16">Llevar los residuos a centros de reciclaje certificados. Estos centros desmantelan y recuperan materiales útiles como metales preciosos o plásticos.</p><br><br>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Reciclaje_especializado_de_los_residuos_electrónicos_peligrosos.jpg" width="350"></div>

<h4 data-i18n="p4.17">Tratamiento de materiales peligrosos</h4><br><br>

<p data-i18n="p4.20">Algunos componentes requieren tratamiento especial para neutralizar los químicos tóxicos antes de su disposición final.</p><br><br>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Tratamiento_de_materiales_peligrosos.png" width="350"></div>

<h4 data-i18n="p4.21">Educación y concientización</h4><br><br>

<p data-i18n="p4.22">Promover campañas para que más personas sepan cómo desechar estos residuos de forma responsable.</p><br><br>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Educación_y_concientización_de_los_residuos_electronicos.jpg" width="350"></div>

<h2 data-i18n="p4.23">¿Dónde llevarlos en México?</h2><br><br>

<p data-i18n="p4.24">Puedes llevarlos a:</p><br><br>

<li data-i18n="p4.25"> Centros de acopio municipales</li><br><br>

<li data-i18n="p4.26">Jornadas de reciclaje electrónico</li><br><br>

<li data-i18n="p4.27">Tiendas de electrónica que aceptan aparatos usados (algunas ofrecen descuentos)</li><br><br>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/centros_de_reparacion_de_equipos_electronicos.webp" width="350"></div>

<h2 data-i18n="p4.28">Recomendaciones personales:</h2><br><br>

<li data-i18n="p4.29">No deseches electrónicos en la basura común.</li><br><br>

<li  data-i18n="p4.30">Elimina tus datos personales antes de entregar dispositivos.</li><br><br>

<li data-i18n="p4.31">Busca sellos de reciclaje responsable como R2 o e-Stewards en centros de reciclaje.</li><br><br>



 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Manejo_Adecuado_de_Residuos_Electronicos_Peligrosos.jpg" width="350"></div>

    <iframe width="590" height="400" src="https://www.youtube.com/embed/05NTpw1PCJg?si=p678M7xthWAuIno8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
