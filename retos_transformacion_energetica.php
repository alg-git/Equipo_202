...
<h1 data-i18n="p8.34">Cuidado del medio ambiente</h1>  
<h2 data-i18n="p8.1">Retos de la Transición Energética</h2>
...
fetch('traductor_retos_transformacion_energetica.json')
...
<h3 data-i18n="p8.2">🌍 ¿Qué es la transición energética?</h3>
<p data-i18n="p8.3"> Es el proceso de cambiar el sistema energético actual, que depende principalmente de combustibles fósiles (como el petróleo, carbón y gas natural), hacia uno basado en energías renovables (como la solar, eólica, hidroeléctrica, geotérmica, etc.). Busca reducir las emisiones de gases de efecto invernadero y combatir el cambio climático.</p>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Uso de Energías Renovables.jpg" width="600"></div>

<h3 data-i18n="p8.4"> ⚠️ Retos principales de la transición energética:</h3>
<h4 data-i18n="p8.5"> 1. 🔋 Almacenamiento de energía</h4>
<p data-i18n="p8.6"> Las energías renovables como la solar y la eólica son intermitentes, es decir, no siempre están disponibles (por ejemplo, no hay sol de noche o viento todos los días).</p>
<p data-i18n="p8.7"> Se necesitan tecnologías de almacenamiento (como baterías de litio o de hidrógeno) para guardar esa energía y usarla cuando se necesite.</p>
<p data-i18n="p8.8"> Sin embargo, estas tecnologías todavía son caras o no están suficientemente desarrolladas a gran escala.</p>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Almacenamiento_de_energía.jpeg" width="600"></div>

<h4 data-i18n="p8.9"> 2. ⚡ Infraestructura obsoleta</h4>
<p data-i18n="p8.10"> Las redes eléctricas actuales fueron diseñadas para un modelo centralizado, con grandes plantas de energía fósil.</p>
<p data-i18n="p8.11"> Las renovables necesitan redes inteligentes que puedan adaptarse a fuentes de energía distribuidas y variables.</p>
<p data-i18n="p8.12"> Actualizar esta infraestructura es costoso y lleva mucho tiempo.</p>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/grandes_plantas_de_energía_fósil.jpeg" width="600"></div>

<h4 data-i18n="p8.13"> 3. 💰 Costos económicos iniciales</h4>
<p data-i18n="p8.14"> Aunque a largo plazo las renovables son más baratas, la inversión inicial en nuevas tecnologías, instalaciones y redes puede ser muy alta.</p>
<p data-i18n="p8.15"> Esto representa una dificultad para países en desarrollo o regiones con pocos recursos económicos.</p>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Costos_económicos_iniciales_de_baterias.jpeg" width="600"></div>

<h4 data-i18n="p8.16"> 4. 🏭 Resistencia de industrias fósiles</h4>
<p data-i18n="p8.17"> Empresas relacionadas con el petróleo, gas y carbón tienen un gran poder económico y político.</p>
<p data-i18n="p8.18"> Muchas veces ejercen presión para frenar políticas que impulsen las renovables, porque les afecta sus ganancias.</p>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/gases.jpg" width="600"></div>

<h4 data-i18n="p8.19"> 5. 👷‍♀️ Impacto en el empleo</h4>
<p data-i18n="p8.20"> La transición cambia el mercado laboral: se pierden empleos en industrias fósiles, y se crean en renovables.</p>
<p data-i18n="p8.21"> Pero esto requiere capacitación y relocalización laboral, lo cual puede ser complicado para muchas personas.</p>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Impacto_en_el_empleo.jpeg" width="600"></div>

<h4 data-i18n="p8.22"> 6. ⚖️ Justicia energética</h4>
<p data-i18n="p8.23"> No todas las comunidades tienen el mismo acceso a energías limpias.</p>
<p data-i18n="p8.24"> Hay un riesgo de que las poblaciones vulnerables queden excluidas de los beneficios de la transición (por ejemplo, por no poder pagar paneles solares).</p>
<p data-i18n="p8.25"> Se busca que la transición sea equitativa y justa, conocida como "transición justa".</p>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Justicia energética.png" width="600"></div>

<h4 data-i18n="p8.26"> 7. 🧪 Desarrollo tecnológico</h4>
<p data-i18n="p8.27"> Aún se necesita investigación para mejorar la eficiencia de tecnologías renovables, baterías, redes inteligentes y captura de carbono.</p>
<p data-i18n="p8.28"> Sin innovación, el proceso se vuelve más lento y menos efectivo.</p>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Desarrollo_tecnológico_con_las_baterias.jpg" width="600"></div>

<h4 data-i18n="p8.29"> 8. 🌎 Coordinación internacional</h4>
<p data-i18n="p8.30"> El cambio climático es global, y se necesita que muchos países actúen en conjunto.</p>
<p data-i18n="p8.31"> Pero hay diferencias políticas, económicas y sociales entre países que dificultan acuerdos y compromisos comunes.</p>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Coordinación_internacional.jpeg" width="600"></div>

<h3 data-i18n="p8.32"> ✅ Conclusión </h3>
<p data-i18n="p8.33">La transición energética es necesaria y urgente, pero enfrenta desafíos técnicos, económicos, sociales y políticos. Superarlos requiere colaboración, inversión, educación y voluntad política para construir un futuro más limpio y justo.</p>

<iframe width="560" height="315" src="https://www.youtube.com/embed/MZLA8e_kdJE?si=oFOtnAf3AAvKs8-o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
