...
<h1 data-i18n="p4.10">Cuidado del medio ambiente</h1>  
<h2 data-i18n="p4.2">Impacto Ambiental de la ganaderia y la pesca</h2>
...
fetch('traductor_Impacto_Ambientalde_la_ganaderia_y_la_pesca.json')
...
<li><a data-i18n="m42" href="cerrar.php">Cerrar</a></li>
     ...
     <div style="padding: 20px; max-width: 800px; margin: auto; background-color: #ffffff; border-radius: 15px;">
        ...
        <p data-i18n="p4.2">Impacto Ambientalde la ganaderia y la pesca</p>
        <p data-i18n="p4.3">La ganadería y la pesca, a pesar de su importancia económica y social, tienen un considerable impacto ambiental. La ganadería, por ejemplo, contribuye a la deforestación, la degradación del suelo, la contaminación del agua y la emisión de gases de efecto invernadero. La pesca, por su parte, puede causar sobreexplotación de recursos pesqueros, alterar ecosistemas marinos y generar contaminación.  </p>
        <br>
  
 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/pesca_ganaderia.jpg" width="350"></div>

        <br>
        <ul>
         <p data-i18n="p4.4"><strong>El enfoqueImpacto ambiental de la ganadería: </strong><br>

             <li><p data-i18n="p4.5"><strong>Deforestación</strong><br>
   <li><p data-i18n="p4.6"><strong>Degradación del suelo.</strong><br>
   <li><p data-i18n="p4.7"><strong>Contaminación del agua</strong><br>
   <li><p data-i18n="p4.8"><strong>Emisión de gases de efecto invernadero</strong><br>
  <li><p data-i18n="p4.9"><strong>Impacto en la biodiversidad</strong><br>
...
. </p></li>
 ...
 <iframe width="560" height="315" src="https://www.youtube.com/embed/QkIX6UnelBY?si=QWCWYnZxigZdQGPI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
 </div>
<footer>  
