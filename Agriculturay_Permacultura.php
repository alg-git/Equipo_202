...
<h2 data-i18n="p4.2">Agricultura y permacultura</h2>
...
fetch('traductor_agricultura_y_permacultura.json')
...
<p data-i18n="p4.1">Causas del Cambio Climático</p>
        <p data-i18n="p4.2">Agricultura y permacultura</p>
        <p data-i18n="p4.3">La permacultura es un sistema de diseño agrícola y social que busca crear sistemas de vida y producción sostenibles, en armonía con la naturaleza y la sociedad. Se basa en la observación de los ecosistemas naturales, la diversificación de cultivos, el aprovechamiento de recursos y la reducción de residuos. </p>
        <br>
   
 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Permacultura.jpg" width="350"></div>


        <br>
        <ul>
         <p data-i18n="p4.4"><strong>El enfoque de la permacultura: </strong><br>

             <li><p data-i18n="p4.5"><strong>Imitación de la naturaleza</strong><br>
   <li><p data-i18n="p4.6"><strong>Sostenibilidad.</strong><br>
   <li><p data-i18n="p4.7"><strong>Autosuficiencia</strong><br>
   <li><p data-i18n="p4.8"><strong>Respeto al medio ambiente</strong><br>
  <li><p data-i18n="p4.9"><strong>Consideración de la sociedad</strong><br>
...
. </p></li>
        ...
        <br>
              <iframe width="590" height="400" src="https://www.youtube.com/embed/PPCO0bVgT1M?si=YEEHdVkWelsv5arq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe> 
              </div> 
<footer>  
