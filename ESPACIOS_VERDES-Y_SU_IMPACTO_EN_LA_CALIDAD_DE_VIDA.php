...
<h1 data-i18n= "p6.10">Cuidado del medio ambiente</h1>  
<h2 data-i18n="p6.1">ESPACIOS VERDES Y SU IMPACTO EN LA CALIDAD DE VIDA</h2>
...
fetch('traductor_ESPACIOS_VERDES_Y_SU_IMPACTO_EN_LA_CALIDAD_DE_VIDA.json')
...
<p data-i18n="p6.2">Los espacios verdes son áreas naturales o ajardinadas dentro de entornos urbanos...</p>
<p data-i18n="p6.3">Beneficios para la salud: Mejoran la salud física y mental...</p>
<p data-i18n="p6.4">Impacto ambiental: Ayudan a reducir la contaminación...</p>
<p data-i18n="p6.5">Impacto social: Fomentan la interacción social...</p>
<p data-i18n="p6.6">Importancia urbana: Las zonas verdes reducen el efecto de isla de calor...</p>
<p data-i18n="p6.7">Economía y educación: Los espacios verdes aumentan el valor inmobiliario...</p>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/areas_verdes.jpg" width="350"></div>

<h2 data-i18n="p6.8">CONCLUSIÓN</h2>
<p data-i18n="p6.9">Invertir en espacios verdes es esencial para construir ciudades saludables...</p>

</div>

    <footer>
    <h1> CBT Dr. Eduardo Suárez, A. Texcoco.</h2>
    <h2> Arellano Venegas Angel Gabriel</h2>
</html>