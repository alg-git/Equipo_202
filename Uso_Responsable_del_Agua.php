...
<h2 data-i18n="p1.2"> Uso responsable del agua</h2>
...
<p data-i18n="p1.1">Causas del Cambio Climático</p>
        <p data-i18n="p1.2">1.Uso responsable del agua</p>
        <p data-i18n="p1.3">Implica utilizar el agua de manera eficiente y consciente para evitar su desperdicio. Esto incluye acciones como cerrar llaves mientras no se usan, reparar fugas y elegir electrodomésticos eficientes.</p>
        <br>

 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/3° estrategias.jpg" width="350"></div>

        <br>
        <ul>
            <li><p data-i18n="p1.4"><strong>Escasez de agua y su impacto global:</strong> La escasez de agua afecta a millones de personas en todo el mundo, especialmente en regiones áridas. Limita el acceso al agua potable, reduce la producción de alimentos y puede provocar conflictos sociales y migraciones.</p></li>
        

            <li><p data-i18n="p1.5"><strong>Estrategias de ahorro:</strong> Incluyen el uso de tecnologías eficientes (como inodoros de bajo consumo), la recolección de agua de lluvia, el riego por goteo en la agricultura y campañas educativas para fomentar hábitos responsables.</p></li>
            <li><p data-i18n="p1.6"><strong>Contaminación del agua y tratamiento:</strong> La contaminación del agua ocurre por desechos industriales, agrícolas y domésticos. El tratamiento del agua implica procesos físicos, químicos y biológicos para eliminar contaminantes y hacerla segura para el consumo y uso diario</p></li>
        </ul>
        <br>
<iframe width="390" height="315" src="https://www.youtube.com/embed/V5jd2oR_qIQ?si=YyXud7RqJ2F11gh0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<footer>  
<h2>Plantel:CBT Dr. Eduardo Suarez A., Texcoco<br>©Oskana Ramirez Vivar</h2>
</footer>