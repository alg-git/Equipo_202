...
<h2 data-i18n="p1.1">Cambio Climatico y Sus Efectos</h2>
...
fetch('traductor_cambio_climatico_y_sus_efectos.json')
...
<li><a data-i18n="m42" href="cerrar.php">Cerrar</a></li>
    ...
    <section>
        <p data-i18n="p1.2"><strong>El cambio climático se refiere a las alteraciones a largo plazo en los patrones del clima global.</strong></p>

              <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/EL-CAMBIO-CLIMATICO-1.jpg" width="600"></div>

       <p data-i18n="p1.3"><strong>Es impulsado principalmente por actividades humanas como la quema de combustibles fósiles, la deforestación y las emisiones industriales.</strong></p>

 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/principales_causas_del_cambio_climatico.avif" width="600"></div>

        <p data-i18n="p1.4">Estas modificaciones en el clima afectan la temperatura media del planeta, alteran los patrones de lluvia y aumentan la frecuencia e intensidad de fenómenos meteorológicos extremos como huracanes, sequías y olas de calor.</p>

 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/alteracion.jpg" width="600"></div>

        <p data-i18n="p1.5">El cambio climático también implica transformaciones ecológicas y sociales profundas: afecta la agricultura, los suministros de agua, la seguridad alimentaria, la salud pública y la migración de personas y especies.</p>

 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/las_cosechas_por_el_cambio_climatico.jpeg" width="600"></div>

      <p data-i18n="p1.6">Los científicos coinciden en que, si no se toman medidas urgentes, las consecuencias serán irreversibles, poniendo en riesgo a las futuras generaciones y al equilibrio de los ecosistemas globales.</p>

<iframe width="560" height="315" src="https://www.youtube.com/embed/GLTCiS6hOT4?si=CA654ka5h6iOASlv" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<footer style="text-align:center;">
    <h3>CBT Dr. Eduardo Suárez A., Texcoco</h3>
    <h4>Integrante: Espinoza Sánchez Omar</h4>
</footer>
</body>
</html>