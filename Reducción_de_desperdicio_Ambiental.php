...
<h2 data-i18n="p4.2">Reducción de Desperdicio de Alimentos</h2>
...
fetch('traducto_Reducción_de_desperdicio_Ambiental.json')
...
<p data-i18n="p4.1">Reducción de desperdicio Ambiental</p>
        <p data-i18n="p4.2">Impacto Ambientalde la ganaderia y la pesca</p>
        <p data-i18n="p4.3">Lareducción del desperdicio ambiental, en particular del desperdicio de alimentos, es crucial para la sostenibilidad del planeta. Implica minimizar la cantidad de recursos naturales utilizados y la generación de residuos, a través de la optimización del uso de los recursos, la reutilización de materiales y la promoción de prácticas de consumo responsables </p>
        <br>
  
 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/desperdicio_de_comida.jpeg" width="350"></div>

        <br>
        <ul>
         <p data-i18n="p4.4"><strong>Como reducir el desperdicio de alimentos: </strong><br>

             <li><p data-i18n="p4.5"><strong>Planificación de comidas</strong><br>
   <li><p data-i18n="p4.6"><strong>Almacenamiento adecuado.</strong><br>
   <li><p data-i18n="p4.7"><strong>Reutilización de restos</strong><br>
   <li><p data-i18n="p4.8"><strong>Compra sostenible</strong><br>
  <li><p data-i18n="p4.9"><strong>Participación de la industria</strong><br>
...
. </p></li>
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/mQgmG76rXd4?si=w1E637pjNyo3yWYf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
<footer>  
