...
<div style="padding: 20px; max-width: 800px; margin: auto; background-color: #ffffff; border-radius: 15px;">
              ...
              <strong><h3>  <p data-i18n="p3.1">Participación de la Sociedad Civil en la Protección del Medio Ambiente 🌿🤝🌍</p></h3></strong>
<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Acuerdo-de-Paris-696x398.jpg" width="350"></div>
<p data-i18n="p3.2"> 
La sociedad civil juega un papel súper importante en la defensa del medio ambiente. Aquí te dejo cómo:
</p>
<p data-i18n="p3.3"> 
🧍‍♀🌱 Formas de participación:
Organizaciones No Gubernamentales (ONGs):
Grupos como Greenpeace, WWF o Sierra Club promueven campañas, denuncian daños ambientales y educan a la población. </p>
<p data-i18n="p3.4"> Movimientos Sociales y Protestas:
Ejemplo: las marchas por el clima, encabezadas por jóvenes como Greta Thunberg, que exigen a gobiernos y empresas que actúen frente al cambio climático.</p>
<p data-i18n="p3.5"> Voluntariado Ambiental:
Muchas personas se suman a actividades de reforestación, limpieza de ríos, reciclaje comunitario, etc.</p>
<p data-i18n="p3.6"> Educación Ambiental:
Desde escuelas hasta talleres comunitarios, la gente impulsa la conciencia ecológica en su entorno.</p>
<p data-i18n="p3.7"> Presión Ciudadana:
A través de peticiones, firmas digitales y redes sociales, la ciudadanía puede presionar por leyes más verdes o impedir megaproyectos destructivos.</p>
<p data-i18n="p3.8"> Consumo Responsable:
Elegir productos ecológicos, reducir el uso de plásticos, apoyar a empresas sostenibles es una forma cotidiana de activismo.</p>
<p data-i18n="p3.9"> 
📍 Ejemplos en acción: </p>
<p data-i18n="p3.10"> México:
El Frente de Pueblos en Defensa de la Tierra y el Agua ha luchado contra proyectos que dañan ecosistemas. </p>
<p data-i18n="p3.11"> Latinoamérica:
Las comunidades indígenas defienden sus territorios de la minería y la deforestación, promoviendo una relación armónica con la naturaleza. </p>
<p data-i18n="p3.12"> Mundo:
Movimientos globales como Fridays for Future movilizan a millones para exigir justicia climática .</p>
</div>

</body>
    <footer>
    <h1> CBT Dr. Eduardo Suárez, A. Texcoco.</h1>
    <h2> ©Angel Gabriel Arellano Venegas</h2>
    </footer>
