...
<h1 data-i18n="p4.1">Cuidado del medio ambiente</h1>  
<h2 data-i18n="p4.2"> Contaminacion del agua y tratamiento </h2>
...
<p data-i18n="p4.1">Causas del Cambio Climático</p>
        <p data-i18n="p4.2">3-Contaminacion del agua y tratamiento </p>
        <p data-i18n="p4.3">El tratamiento del agua, que incluye la remoción de estos contaminantes, es esencial para garantizar la seguridad y la calidad del agua potable.</p>
        <br>
   <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/1°_uso.jpg" width="350"></div>

        <br>
        <ul>
         <p data-i18n="p4.4"><strConsecuencias de la contaminación del agua:</strong><br>

             <li><p data-i18n="p4.5"><strong> Impactos en la salud.</strong><br>
   <li><p data-i18n="p4.6"><strong>Impactos en la vida silvestre.</strong><br>
   <li><p data-i18n="p4.7"><strong>Impactos en los ecosistemas acuático.</strong><br>
   <li><p data-i18n="p4.8"><strong>Impactos en la calidad del agua potable</strong><br>
...
. </p></li>
                        ...
                        <li><p data-i18n="p4.9"><strong>Tratamiento del agua:</strong>
Transformar objetos viejos en nuevas utilidades, como convertir frascos en recipientes, reutilizar telas para crear nuevos productos o reparar prendas en lugar de reemplazarlas. </p></li>
        ...
        <iframe width="590" height="400" src="https://www.youtube.com/embed/iPCUpCDhdsE?si=8x0KV0eT6GJum00l title=YouTube video player frameborder=0 allow=accelerometer"; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share referrerpolicy=strict-origin-when-cross-origin allowfullscreen></iframe>
        </div>
