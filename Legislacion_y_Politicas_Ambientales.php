...
<h2 data-i18n="p2.18">Legislacion y Politicas Ambientales</h2>
...
fetch('traductor_Legislacion_y_Politicas_Ambientales.json')
...
<div style="padding: 20px; max-width: 800px; margin: auto; background-color: #ffffff; border-radius: 15px;">
        ...
        <h1 data-i18n="p2.1">LEGISLACIÓN</h1>
        <p data-i18n="p2.2">La legislación ambiental es el conjunto de leyes, normas y reglamentos que tienen como objetivo proteger el medio ambiente y regular el uso sostenible de los recursos naturales.</p>
        <h2 data-i18n="p2.3">Ejemplos de legislación</h2>
      
       <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/que-es-la-legislacion-ambiental.webp" width="350">

        <p data-i18n="p2.4">México: Ley General del Equilibrio Ecológico y la Protección al Ambiente (LGEEPA): Regula la conservación, restauración y aprovechamiento sustentable de los recursos naturales. Colombia</p>
        <p data-i18n="p2.5">Ley 99 de 1993: Crea el Ministerio de Ambiente y organiza el Sistema Nacional Ambiental (SINA). Introduce principios como el desarrollo sostenible y la participación ciudadana. Estados Unidos:</p>
        <p data-i18n="p2.6">Clean Water Act (1972): Regula la contaminación del agua. Clean Air Act (1963, modificado en 1990): Control de emisiones atmosféricas de contaminantes.</p>
        <p data-i18n="p2.7">Unión Europea: Directiva Marco del Agua (2000): Protege la calidad del agua en todos los países miembros. Reglamento REACH (2006): Controla el uso de sustancias químicas peligrosas.</p>
        <h3 data-i18n="p2.8">POLÍTICAS AMBIENTALES</h3>
        <p data-i18n="p2.9">Las políticas ambientales son el conjunto de estrategias, planes y acciones que diseñan los gobiernos para proteger el medio ambiente, promover el desarrollo sostenible y adaptarse al cambio climático.</p>
      
              <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/politicas_ambientales.jpeg" width="350">

        <h3 data-i18n="p2.10">Ejemplos de políticas ambientales</h3>
        <p data-i18n="p2.11">México: Estrategia Nacional de Cambio Climático: Política de largo plazo para reducir emisiones de gases de efecto invernadero y aumentar la resiliencia.</p>
        <p data-i18n="p2.12">Costa Rica: Programa de Pagos por Servicios Ambientales (PSA): Compensa a los propietarios de bosques por conservar y proteger ecosistemas.</p>
        <p data-i18n="p2.13">Unión Europea: European Green Deal (2019): Plan integral para lograr neutralidad climática en 2050, incluye economía circular, agricultura sostenible y movilidad limpia.</p>
        <p data-i18n="p2.14">Chile: Plan de Descarbonización: Retiro gradual de centrales a carbón para alcanzar la carbono-neutralidad en 2050.</p>
    
           <iframe width="560" height="315" src="https://www.youtube.com/embed/3OsXlctyRdM?si=2s5kSnLxTzEyEO62" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<h2> Integrantes: Arellano Venegas Angel Gabriel</h2>
</footer>  
