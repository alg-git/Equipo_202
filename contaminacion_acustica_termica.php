...
<h1 data-i18n="p4.44">Cuidado del medio ambiente</h1>  
<h2 data-i18n="p4.1">Contaminación acústica y térmica</h2>
...
fetch('traductor_contaminacion_acustica_termica.json')
...
<li><a data-i18n="m42" href="cerrar.php">Cerrar</a></li>
  ...
  <h3 data-i18n="p4.2">Contaminación Acústica </h3>
  <h4 data-i18n="p4.3">¿Qué es? </h4>
  <p data-i18n="p4.4">La contaminación acústica es la presencia de ruido excesivo o molesto que interfiere en las actividades normales del ser humano y afecta su salud y bienestar. No es visible, pero sus efectos pueden ser graves. </p>
  
<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/contaminacion_auditiva .jpg" width="600"></div>

  <h4 data-i18n="p4.5">Principales Causas </h4>
  <p data-i18n="p4.6">Tráfico vehicular (autos, motos, camiones). </p>
  <p data-i18n="p4.7">Aeropuertos y aviones. </p>
  <p data-i18n="p4.8">Industrias y maquinaria pesada. </p>
  <p data-i18n="p4.9">Obras de construcción. </p>
  <p data-i18n="p4.10">Música alta en zonas urbanas. </p>
  <p data-i18n="p4.11">Multitudes o aglomeraciones. </p>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/IMG-20250606-WA0010.jpg" width="600"></div>

  <h4 data-i18n="p4.12">Consecuencias </h4>
  <p data-i18n="p4.13">Estrés y ansiedad. </p>
  <p data-i18n="p4.14">Pérdida de audición (en exposiciones prolongadas). </p>
  <p data-i18n="p4.15">Alteraciones del sueño. </p>
  <p data-i18n="p4.16">Problemas de concentración y bajo rendimiento escolar o laboral. </p>
  <p data-i18n="p4.17">Afectación a los animales (interrupción de su comunicación o comportamiento natural). </p>
    
<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/IMG-20250606-WA0010.jpg" width="600"></div>

  <h4 data-i18n="p4.18">Soluciones </h4>
  <p data-i18n="p4.19">Uso de materiales aislantes de sonido en construcciones. </p>
  <p data-i18n="p4.20">Regulación del tráfico y límites de velocidad. </p>
  <p data-i18n="p4.21">Control de horarios para actividades ruidosas. </p>
  <p data-i18n="p4.22">Campañas de concientización ciudadana. </p>
  <p data-i18n="p4.23">Áreas verdes como “barreras naturales” de sonido. </p>
<iframe width="560" height="315" src="https://www.youtube.com/embed/DPJfYfVTyZU?si=o-Muoyi3FkZrGb0D" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

  <h3 data-i18n="p4.24">Contaminación  Térmica </h3>
  <h4 data-i18n="p4.25">¿Qué es? </h4>
  <p data-i18n="p4.26">La contaminación térmica ocurre cuando una fuente artificial aumenta la temperatura natural del agua o del ambiente, alterando los ecosistemas. Es común en cuerpos de agua cercanos a industrias o plantas de energía. </p>
          
<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Contaminación_Térmica.jpg" width="600"></div>

  <h4 data-i18n="p4.27">Principales Causas </h4>
  <p data-i18n="p4.28">Vertido de agua caliente por parte de centrales térmicas o nucleares. </p>
  <p data-i18n="p4.29">Uso excesivo del aire acondicionado en zonas urbanas (islas de calor). </p>
  <p data-i18n="p4.30">Deforestación (reduce la sombra y la humedad natural). </p>
<p data-i18n="p4.31">Construcción de superficies asfaltadas que absorben el calor. </p>
       
<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Deforestación_(reduce_la_sombra_y_la_humedad_natural)..webp" width="600"></div>

  <h4 data-i18n="p4.32">Consecuencias </h4>
  <p data-i18n="p4.33">Disminución del oxígeno disuelto en ríos y lagos. </p>
  <p data-i18n="p4.34">Muerte de peces y otras especies acuáticas. </p>
  <p data-i18n="p4.35">Desequilibrio en los ecosistemas acuáticos. </p>
  <p data-i18n="p4.36">Aumento de enfermedades por proliferación de bacterias en aguas cálidas. </p>
  <p data-i18n="p4.37">Calentamiento urbano excesivo (afecta la salud de las personas). </p>
   
<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Aumento_de_enfermedades_por_proliferación_de_bacterias_en_aguas_cálidas.jpeg" width="600"></div>

  <h4 data-i18n="p4.38">Soluciones </h4>
  <p data-i18n="p4.39">Enfriamiento del agua antes de verterla en ríos o lagos. </p>
  <p data-i18n="p4.40">Mayor uso de energías limpias. </p>
  <p data-i18n="p4.40">Plantación de árboles y techos verdes. </p>
  <p data-i18n="p4.42">Mejora del diseño urbano para evitar islas de calor. </p>
  <p data-i18n="p4.43">Reutilización del calor residual en procesos industriales.</p>
<iframe width="560" height="315" src="https://www.youtube.com/embed/C9pUK0fSsxU?si=GEGmNtO9kviRNSKm" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
