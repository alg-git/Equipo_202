...
<h1 data-i18n="p1.19">Cuidado del medio ambiente</h1>  
<h2 data-i18n="p1.1"> conciencia y educacion Ambiental</h2>
...
fetch('traductor_contaminacion_ambiental.json')
...
<li><a data-i18n="m42" href="cerrar.php">Cerrar</a></li>
    ...
    <div style="padding: 20px; max-width: 800px; margin: auto; background-color: #ffffff; border-radius: 15px;">
      <label for="sitio">
        ...
        <h3 data-i18n="p1.2">Definición, causas y tipos principales </h3>
        <p data-i18n="p1.3">La contaminación ambiental incluye agentes nocivos de origen humano que afectan al equilibrio natural, perjudicando a personas, animales y ecosistemas. </p>
        <p data-i18n="p1.4">Martin Luther King dijo que “si supiera que el mundo acaba mañana, yo, todavía hoy, plantaría un árbol”. Hace más de 50 años, ya existía conciencia sobre la importancia de la sostenibilidad del planeta y el bienestar para las generaciones futuras. </p>
      <label for="sitio">

      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/martin.jpg" width="600"></div>


                <p data-i18n="p1.5">Hoy, las políticas medioambientales forman una parte fundamental de las agendas de muchos gobiernos mundiales. La mayoría de ellas, con un foco puesto en la reducción de los niveles de contaminación ambiental. </p>
        <p data-i18n="p1.6">Tradicionalmente, como afirma la Organización de las Naciones Unidas (ONU) en uno de sus informes medioambientales, la tala indiscriminada de árboles y de bosques, en general, era la principal causa de deterioro de los ecosistemas. </p>
        <p data-i18n="p1.7">Sin embargo, desde la irrupción de la Revolución Industrial, la emisión a la atmósfera de gases de efecto invernadero se ha convertido en el principal acto de contaminación ambiental. Además, cabe destacar otros. </p>   <p data-i18n="p1.8">Entre ellos, los vertidos industriales a la hidrosfera, la producción de energía con combustibles fósiles (junto a, por supuesto, su extracción, procesamiento y refinamiento). También, el uso indiscriminado de plásticos y de otros materiales derivados del ‘oro negro’. </p> 
      <label for="sitio">

       <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/petroleo.jpg" width="600"></div>


        <h3 data-i18n="p1.9">Tipos principales de contaminación ambiental </h3>
        <p data-i18n="p1.10">Contaminación atmosférica: Partículas en suspensión y gases producidos por el tráfico rodado, la industria y las calefacciones son los principales causantes de la contaminación atmosférica. </p>
        <p data-i18n="p1.11">Contaminación hídrica: Afecta a ríos, fuentes de agua subterránea, lagos y mar cuando se liberan residuos contaminantes. </p>
        <p data-i18n="p1.12">Contaminación del suelo: La contaminación de los suelos afecta a todos los continentes y hasta a las regiones más remotas de la Tierra. </p>
        <p data-i18n="p1.13">Contaminación acústica: Se produce con cualquier ruido excesivo ya sea en proporción, frecuencia, tono, volumen o ritmo. </p>
        <p data-i18n="p1.14">Contaminación lumínica: La contaminación lumínica provoca que una de cada tres personas apenas vea el cielo estrellado. Por no hablar de cómo afecta al sueño y al consumo de energía. </p>
        <p data-i18n="p1.15">Contaminación visual: Altera visualmente el paisaje. Hace referencia a todos los elementos que no son naturales y que nos envían estímulos visuales. Pueden ser vallas publicitarias, torres eléctricas, etc. </p>
        <p data-i18n="p1.16">Contaminación térmica: El aumento de la temperatura (o calentamiento global) afecta a los polos y los glaciares. </p>
              <label for="sitio">
<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/tiposconta.jpg" width="600"></div>


        <p data-i18n="p1.17">En cualquier caso, es preciso señalar que la propia naturaleza genera situaciones de contaminación grave, aunque, también es cierto, que cuenta con sus propios mecanismos de depuración y de reciclaje.  </p>
                <p data-i18n="p1.18">En este sentido, son ejemplos las erupciones volcánicas, los huracanes o los incendios (sin intervención humana), si bien son inevitables, algo que en el caso de muchas de las actividades del hombre que generan contaminación ambiental sí que podrían, al menos, reducirse, como es el caso de transformar un ecosistema para desarrollar un cultivo de plantas destinadas a la producción de biocombustibles. </p>
               
<iframe width="560" height="315" src="https://www.youtube.com/embed/TV-YEQOIFuQ?si=qqtLFNFuynw6kJXG" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
 </div>
</body>
<footer>  
