...
<h2 data-i18n="p5.1">Biodiversidad y Ecosistemas</h2>
...
fetch('traductor_Biodiversidad_y_Ecosistemas.json')
...
<p data-i18n="p5.2"><strong>La biodiversidad se refiere a la variedad de seres vivos en la Tierra, incluyendo plantas, animales, hongos, bacterias y otros organismos. Esta diversidad ocurre en tres niveles:</strong></p>

<ul>
    <li>
        <h4 data-i18n="p5.3">Diversidad Genética:</h4>
        <ul>
            <li data-i18n="p5.4">Variación dentro de una misma especie (por ejemplo, diferentes razas de perros o tipos de maíz).</li>
        </ul>
    </li>

    <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/diversidad_de_genetica.png" width="600"></div>

    <li>
        <h4 data-i18n="p5.5">Diversidad de Especies:</h4>
        <ul>
            <li data-i18n="p5.6">Cantidad y variedad de especies que existen en una región o en el planeta. Incluye animales, plantas, hongos y microorganismos.</li>
        </ul>
    </li>

    <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Diversidad_de_Especies.jpg" width="600"></div>

    <li>
        <h4 data-i18n="p5.7">Diversidad de Ecosistemas:</h4>
        <ul>
            <li data-i18n="p5.8">Diferentes tipos de entornos naturales donde viven los organismos, como bosques, océanos, desiertos, selvas, manglares, tundras y humedales.</li>
        </ul>
    </li>

    <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/diversidad_de_ecosistemas.jpg" width="600"></div>

</ul>

<p data-i18n="p5.9">Un ecosistema es un sistema natural formado por un conjunto de organismos vivos (biocenosis) que interactúan entre sí y con el medio físico (biotopo). Estas interacciones permiten el flujo de energía y el reciclaje de nutrientes. Ejemplos de ecosistemas incluyen arrecifes de coral, selvas tropicales, desiertos, lagos y pastizales.</p>

<p data-i18n="p5.11">Los ecosistemas pueden ser terrestres (como bosques o sabanas) o acuáticos (como ríos, océanos o lagos), y cada uno alberga diferentes formas de vida adaptadas a sus condiciones particulares de temperatura, humedad, altitud o salinidad.</p>

    <p data-i18n="p5.9">Un ecosistema es una comunidad de seres vivos que interactúan entre sí y con su entorno físico (como el agua, el aire y el suelo). Ejemplos incluyen selvas, océanos, desiertos y humedales.</p>
       
<iframe width="560" height="315" src="https://www.youtube.com/embed/IJZuRgvPRb0?si=ljhQvrDwU30PgJ9C" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
