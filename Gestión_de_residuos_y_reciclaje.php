...
<h1 data-i18n="p1.10">Cuidado del medio ambiente</h1>  
<h2 data-i18n="p1.11"> Gestion de reduccion y reciclaje</h2>
...
<h2 data-i18n="p1.11">Gestion de residuos y reciclaje</h2>

<p data-i18n="p1.1">La gestión de residuos y reciclaje es un conjunto de procesos destinados a recolectar, transportar, tratar y disponer de los residuos sólidos, así como a recuperar materiales reutilizables para su reintegración en el ciclo productivo. Su objetivo principal es reducir el impacto ambiental y fomentar la sostenibilidad.</p><br>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Gestion_de_residuos_y_reciclaje.jpg" width="600"></div>


<h2 data-i18n="p1.2">Etapas de la gestión de residuos</h2><br><br>

<h3 data-i18n="p1.3">Generación de residuos</h3><br><br>

<li data-i18n="p1.4">Ocurre en hogares, industrias, comercios, hospitales, etc. </li><br><br>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/alteracion_del_agua.jpg" width="600"></div>

<h3 data-i18n="p1.5">Recolección y transporte</h3><br><br>

<li data-i18n="p1.6">Implica el acopio y traslado de los residuos a centros de tratamiento o disposición final.</li><br><br>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Recolección_y_transporte_de_basura.avif" width="600"></div>

<h3 data-i18n="p1.7">Clasificación o separación</h3><br><br>

<p data-i18n="p1.8">Se separan los residuos en:</p><br>

<li data-i18n="p1.9">Orgánicos (restos de comida, vegetales, etc.)</li><br>

<li data-i18n="p1.12">Inorgánicos reciclables (plástico, vidrio, metal, papel, cartón)</li><br>

<li data-i18n="p1.13">Inorgánicos no reciclables o peligrosos (pilas, medicamentos, electrónicos, etc.)</li><br><br>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/clasificación_y_separación_en_basuras.jpg" width="600"></div>

<h3 data-i18n="p1.14">Tratamiento</h3><br><br>

<p data-i18n="p1.15">Métodos como compostaje, incineración, reciclaje, tratamiento biológico, etc.</p><br><br>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Métodos_como_compostaje,_incineración,_reciclaje,_tratamiento_biológico.jpg" width="600"></div>

<h3 data-i18n="p1.16">Disposición final</h3><br><br>

<p data-i18n="p1.17">Depósito en rellenos sanitarios o vertederos, cuando no es posible recuperar o tratar los residuos.</p><br><br>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Depósito_en_rellenos_sanitarios_o_vertederos,_cuando_no_es_posible_recuperar_o_tratar_los_residuos..jpeg" width="600"></div>

<h2 data-i18n="p1.18">Tipos de reciclaje</h2><br><br>

<p data-i18n="p1.19"> Reciclaje mecánico: separación, lavado y fundición de materiales (plásticos, metales, vidrio).</p><br><br>

<p data-i18n="p1.20">Reciclaje químico: descomposición de materiales para obtener compuestos reutilizables.</p><br><br>

<p data-i18n="p1.21">Reciclaje orgánico: transformación de residuos biodegradables en abono mediante compostaje o biodigestión.</p><br><br>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Tipos_de_reciclaje_mecánico_quimico_y_organico.jpg" width="600"></div>

<h3 data-i18n="p1.22">Beneficios del reciclaje</h3><br><br>

<li data-i18n="p1.23"> Reducción del volumen de residuos.</li><br><br>

<li data-i18n="p1.24">Disminución del uso de materias primas vírgenes.</li><br><br>

<li data-i18n="p1.25">Ahorro de energía.</li><br><br>

<li data-i18n="p1.26">Reducción de la contaminación.</li><br><br>

<li data-i18n="p1.27">Fomento de la economía circular y generación de empleo verde.</li><br><br>

<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Beneficios_del_reciclaje.jpeg" width="600"></div>

<iframe width="590" height="400" src="https://www.youtube.com/embed/W_udAZvJ2Zw?si=BtiOLvNH0MhfW9An" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
