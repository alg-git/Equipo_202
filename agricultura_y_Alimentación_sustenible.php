...
<h2 data-i18n="p4.2"> Agricultura y alimentación sostenible</h2>
...
fetch('traductor_agricultura_y_Alimentación_sustenible.json')
...
<p data-i18n="p4.1">Causas del Cambio Climático</p>
        <p data-i18n="p4.2">Agricultura y alimentación sostenible</p>
        <p data-i18n="p4.3">se enfocan en producir alimentos de manera que se minimice el impacto ambiental, se conserve la biodiversidad y se asegure la seguridad alimentaria para las generaciones futura</p>
        <br>
   
 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/omar_imagen3.jpg" width="350"></div>

        <br>
        <ul>
         <p data-i18n="p4.4"><strong>Este tema se divide en los siguientes subtemas   </strong><br>

             <li><p data-i18n="p4.5"><strong>Agricultura y permacultura</strong><br>
   <li><p data-i18n="p4.6"><strong>Impacto ambiental de la ganadería y la pesca .</strong><br>
   <li><p data-i18n="p4.7"><strong>Reducción de desperdicio de alimentos </strong><br>
...
. </p></li>
   ...
   <iframe width="590" height="400" src="https://www.youtube.com/embed/KN71NAWflu0?si=gAlCm5hKA2lc1RTx" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
