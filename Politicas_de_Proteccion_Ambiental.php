...
<h1 data-i18n= "p1.6">Cuidado del medio ambiente</h1>  
<h2 data-i18n="p1.1">Políticas de Protección Ambiental en Distintos Países 🌎🌿</h2>
...
fetch('traductor_Políticas_de_Protección_Ambiental_en_Distintos_Países.json')
...
<div style="padding: 20px; max-width: 800px; margin: auto; background-color: #ffffff; border-radius: 15px;">
              <strong><h3>  <p data-i18n="p1.1">Políticas de Protección Ambiental en Distintos Países 🌎🌿</p></h3></strong>
<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/politicas_ambientales2.jpeg" width="350"></div>
<p data-i18n="p1.2">México:
Cuenta con la Ley General del Equilibrio Ecológico y la Protección al Ambiente (LGEEPA).
Tiene instituciones como SEMARNAT y PROFEPA que supervisan y aplican políticas ambientales.
Se impulsa el uso de energías renovables y el control de emisiones contaminantes.
</p>
<p data-i18n="p1.3">Alemania:
Es líder en energías limpias y sostenibilidad.
Tiene un plan llamado Energiewende, que busca eliminar el uso de energía nuclear y depender más de fuentes renovables.
Su legislación es estricta con la industria y promueve el reciclaje intensivo.
</p>
<p data-i18n="p1.4">Brasil:
Posee leyes como el Código Forestal, que regula el uso del suelo y protege los bosques.
Enfrenta desafíos con la deforestación del Amazonas.
A pesar de políticas, la implementación ha sido inconsistente por conflictos políticos y económicos.
</p>
<p data-i18n="p1.5">Suecia:
Uno de los países más verdes.
Promueve la economía circular y tiene altos impuestos al carbono.
Ha logrado reducir significativamente sus emisiones sin afectar su economía.</p>
</div>

</body>
    <footer>
     CBT Dr. Eduardo Suárez, A. Texcoco.
    <br> ©Angel Gabriel Arellano Venegas
    </footer>
