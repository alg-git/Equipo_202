...
<h1 data-i18n="p2.29">Cuidado del medio ambiente</h1>  
<h2 data-i18n="p2.1">Causas del Cambio Climático y Sus Efectos</h2>
...
fetch('traductor_causas_del_cambio_climatico.json')
...
<li><a data-i18n="m42" href="cerrar.php">Cerrar</a></li>
    ...
    <ul>  
        <li>  
            <p data-i18n="p2.2">Emisión de Gases de Efecto Invernadero:</p>  
            <ul>  
                <li data-i18n="p2.3">Por quema de combustibles fósiles (carbón, petróleo, gas natural).</li>  
                <li data-i18n="p2.4">Utilizados en transporte, industria y generación eléctrica desde la Revolución Industrial.</li>  
            </ul>  
        </li>  

        <li>  
            <p data-i18n="p2.5">Deforestación:</p>  
            <ul>  
                <li data-i18n="p2.6">Reducción de la absorción de CO₂ al talar árboles.</li>  
                <li data-i18n="p2.7">Causada por expansión agrícola, ganadera y urbanización.</li>  
            </ul>  
        </li>  
 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/omar_imangen2.jpg" width="600"></div>
        <li>  
            <p data-i18n="p2.8">Agricultura Intensiva:</p>  
            <ul>  
                <li data-i18n="p2.9">Produce metano (ganado) y óxidos de nitrógeno (fertilizantes).</li>  
                <li data-i18n="p2.10">Surgió con el aumento de la demanda alimentaria global.</li>  
            </ul>  
        </li>  
 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/omar_imagen3.jpg" width="600"></div>
        <li>  
            <p data-i18n="p2.11">Uso Excesivo de Recursos Naturales:</p>  
            <ul>  
                <li data-i18n="p2.12">Sobreexplotación de agua, minería, pesca, etc.</li>  
                <li data-i18n="p2.13">Impulsado por el crecimiento de la población y el consumo.</li>  
            </ul>  
        </li>  
 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Uso_Excesivo_de_Recursos_Naturales.jpeg" width="600"></div>
        <li>  
            <p data-i18n="p2.14">Contaminación Industrial:</p>  
            <ul>  
                <li data-i18n="p2.15">Emisión de químicos a la atmósfera, ríos y mares.</li>  
                <li data-i18n="p2.16">La industrialización masiva del siglo XX agravó esta causa.</li>  
            </ul>  
        </li>  
 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/omar_4.jpg" width="600"></div>
        <li>  
            <p data-i18n="p2.17">Urbanización Desmedida:</p>  
            <ul>  
                <li data-i18n="p2.18">Construcción sin planificación incrementa el consumo energético.</li>  
                <li data-i18n="p2.19">Crece por la migración rural a ciudades y la falta de políticas sostenibles.</li>  
            </ul>  
        </li>  
 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Urbanización_Desmedida.jpg" width="600"></div>
        <li>  
            <p data-i18n="p2.20">Generación Eléctrica No Renovable:</p>  
            <ul>  
                <li data-i18n="p2.21">Centrales térmicas emiten gran cantidad de CO₂ al usar carbón o gas natural.</li>  
                <li data-i18n="p2.22">Estas tecnologías surgieron antes del desarrollo de las energías limpias.</li>  
            </ul>  
        </li>  
 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Generación_Eléctrica_No_Renovable.jpg" width="600"></div>
        <li>  
            <p data-i18n="p2.23">Gestión Inadecuada de Residuos:</p>  
            <ul>  
                <li data-i18n="p2.24">Los vertederos producen metano por descomposición de residuos orgánicos.</li>  
                <li data-i18n="p2.25">La falta de reciclaje y compostaje agrava esta emisión.</li>  
            </ul>  
        </li>  
 <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Gestión_Inadecuada_de_Residuos.webp" width="600"></div>
        <li>  
            <p data-i18n="p2.26">Consumo Excesivo:</p>  
            <ul>  
                <li data-i18n="p2.27">Sobreproducción de bienes genera más emisiones, energía y basura.</li>  
                <li data-i18n="p2.28">Promovido por el consumismo y el modelo económico lineal.</li>  
            </ul>  
        </li>  

         <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Consumo_Excesivo.jpeg" width="600"></div>
    </ul>  

    <iframe width="560" height="315" src="https://www.youtube.com/embed/CIrNSNnbvJU?si=rZj-sl5os9lZjSjb" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
</main>  
  
<footer style="text-align:center;">  
    <h2>CBT Dr. Eduardo Suárez A., Texcoco</h2>  
    <p>Integrante: Espinoza Sánchez Omar</p>  
</footer>  
