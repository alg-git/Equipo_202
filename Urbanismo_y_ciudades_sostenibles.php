...
<h1 data-i18n="p6.16">Cuidado del medio ambiente</h1>  
<h2 data-i18n="p6.17">Urbanas y ciudades sostenibles</h2>
...
fetch('traductor_Urbanismo_y_ciudades_sostenibles.json')
...
<li><a data-i18n="m42" href="cerrar.php">Cerrar</a></li>
    ...
    <div style="padding: 20px; max-width: 800px; margin: auto; background-color: #ffffff; border-radius: 15px;">
      <label for="sitio">
            ...
            <h1 data-i18n="p6.1">URBANISMO</h1>
            <p data-i18n="p6.2">El urbanismo es la disciplina que estudia la planificación y el desarrollo de las ciudades y los asentamientos humanos. Su objetivo es organizar el territorio para garantizar el bienestar de la población, la eficiencia en el uso de recursos y la sostenibilidad del entorno.</p>
          
             <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Urbanismo-Verde.webp" width="350"></div>

  <p data-i18n="p6.3"> Movilidad sostenible: Fomento del transporte público, ciclovías y movilidad peatonal. </p>
      <p data-i18n="p6.4">Eficiencia energética: Uso de energías renovables y edificaciones con eficiencia energética.      </p>
 <p data-i18n="p6.5">  Gestión de residuos: Reducción, reciclaje y reutilización de desechos.      </p>
  <p data-i18n="p6.6"> Zonas verdes y biodiversidad: Creación de parques y áreas naturales para mejorar la calidad del aire y la salud pública.     </p>
   <p data-i18n="p6.7">Diseño urbano compacto y mixto: Evitar la expansión descontrolada y fomentar la cercanía entre vivienda, trabajo y servicios.      </p>
  <p data-i18n="p6.8"> Tecnología y digitalización: Implementación de soluciones inteligentes para optimizar servicios urbanos.     </p> 
  <h2 data-i18n="p6.9">CIUDADES SOSTENIBLES </h2>
       
    <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/siciedades_sostenibles.jpeg" width="350"></div>

 <p data-i18n="p6.10">Por otro lado, las ciudades sostenibles son aquellas que buscan equilibrar el crecimiento urbano con la preservación del medio ambiente, la equidad social y la viabilidad económica. Se basan en principios como la movilidad eficiente, la gestión adecuada de residuos, el uso de energías renovables y la inclusión social. </p> 
 <p data-i18n="p6.11">Ejemplos de ciudades sostenibles  </p>
<p data-i18n="p6.12">Copenhague (Dinamarca): Líder en movilidad en bicicleta y uso de energías limpias.</p>
<p data-i18n="p6.13">Singapur: Uso eficiente del agua y tecnología para la planificación urbana. </p>
    <p data-i18n="p6.14">Curitiba (Brasil): Pionera en transporte público eficiente y planificación ecológica. </p> 
<p data-i18n="p6.15">Ámsterdam (Países Bajos): Promoción de la movilidad en bicicleta y el desarrollo urbano compacto.</p>

<iframe width="560" height="315" src="https://www.youtube.com/embed/2fn4NW4NWF4?si=JI2ak0Usnd16B71A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
