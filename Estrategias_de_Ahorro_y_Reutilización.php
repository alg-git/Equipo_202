...
<h1 data-i18n="p2.1">Cuidado del medio ambiente</h1>  
<h2 data-i18n="p2.2"> Estrategias de ahorro y reutilización</h2>
...
<p data-i18n="p2.1">Causas del Cambio Climático</p>
        <p data-i18n="p2.2">2-Estrategias de ahorro y reutilizacion </p>
        <p data-i18n="p2.3">La escasez de agua es uno de los mayores desafíos que enfrenta el mundo actualmente. Más de 2 mil millones de personas viven en países con alto estrés hídrico, lo que significa que no tienen suficiente agua para satisfacer sus necesidades básicas</p>
        <br>
   
   <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/3° estrategias.jpg" width="600"></div>
   
        <br>
        <ul>
            <li><p data-i18n="p2.4"><strong>Consumo responsable:</strong>
Comprar solo lo necesario, evitando compras impulsivas y optando por productos con menos embalaje. .</p></li>
        

            <li><p data-i18n="p2.5"><strong>Evitar productos desechables:</strong>
Optar por alternativas reutilizables, como botellas de agua, bolsas de tela y recipientes para alimentos. </p></li>
            <li><p data-i18n="p2.6"><strong>Variabilidad climática:</strong>Dar nuevos usos a objetos:</strong>
Transformar objetos viejos en nuevas utilidades, como convertir frascos en recipientes, reutilizar telas para crear nuevos productos o reparar prendas en lugar de reemplazarlas. </p></li>
        </ul>
        <br>
               
        <center,><i<iframe width="560" height="315" src=https://www.youtube.com/embed/NDrd1DNU_8M?si=RPUeSbFvynzKW2mv title=YouTube video player frameborder=0 allow=accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share referrerpolicy=strict-origin-when-cross-origin allowfullscreen></iframe></iframe>
            </ul>
