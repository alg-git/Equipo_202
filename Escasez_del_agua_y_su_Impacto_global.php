...
<h2 data-i18n="p2.2"> Escasez del agua</h2>
...
<p data-i18n="p2.1">Causas del Cambio Climático</p>
        <p data-i18n="p2.2">1.escasez de agua</p>
...
<div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/cambio.jpg" width="350"></div>

        <br>
        <ul>
            <li><p data-i18n="p2.4"><strong>Las causas del la escazea del agua son: </strong> La extracción excesiva de agua subterránea sin una recarga adecuada lleva a la disminución de los niveles de los acuíferos.</p></li>
        

            <li><p data-i18n="p2.5"><strong>Contaminación del agua:</strong> La descarga de aguas residuales sin tratar, desechos industriales y agrícolas contamina los ríos y lagos, haciendo que el agua no sea potable. </p></li>
            <li><p data-i18n="p2.6"><strong>Variabilidad climática:</strong> El cambio climático puede aumentar la frecuencia e intensidad de sequías, reduciendo la disponibilidad de agua. </p></li>
        </ul>
        <br>
        <center,><iframe width="380" height="315" src="https://www.youtube.com/embed/k0Wthd5Tp7Y?si=zmyw5Vh6eBgZQ_4"s title="YouTube video player" frameborder="0" allow="
