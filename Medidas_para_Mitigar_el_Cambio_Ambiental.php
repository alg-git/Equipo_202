...
<h1 data-i18n="m43">Cuidado del medio ambiente</h1>  
<h2 data-i18n="PM.1">Paguina Principal</h2>
...
<ul>
  <h4 data-i18n="p4.2"><li>Uso de Energías Renovables:</li></h4>
  <h5><ul>
      <li data-i18n="p4.3">Sustituir el uso de combustibles fósiles por energía solar, eólica, hidroeléctrica o geotérmica.</li>
    </ul></h5>

    <div style="text-align:center; margin: 2px 0;">
     <img class="img"src="Imagenes/Uso de Energías Renovables.jpg" width="350">
       

  <h4 data-i18n="p4.4"><li>Eficiencia Energética:</li></h4>
    <h5><ul>
      <li data-i18n="p4.5">Utilizar aparatos eléctricos de bajo consumo.</li>
      <li data-i18n="p4.6">Mejorar el aislamiento de casas y edificios para reducir el uso de calefacción o aire acondicionado.</li>
    </ul></h5>

    <div style="text-align:center; margin: 2px 0;">
   <img class="img"src="Imagenes/Manejo_Adecuado_de_Residuos_Electronicos_Peligrosos.jpg" width="350">

  <h4 data-i18n="p4.7"><li>Movilidad Sustentable:</li></h4>
  <h5><ul>
      <li data-i18n="p4.8">Promover el uso del transporte público, bicicletas o vehículos eléctricos.</li>
      <li data-i18n="p4.9">Caminar más y reducir el uso de autos particulares.</li>
  </ul></h5>

  <div style="text-align:center; margin: 2px 0;">
     <img class="img"src="Imagenes/movilidad_sustentable.jpeg" width="350">

    <h4 data-i18n="p4.10"><li>Reforestación y Protección de Bosques:</li></h4>
  <h5><ul>
      <li data-i18n="p4.11">Plantar árboles y conservar los ecosistemas naturales que absorben CO₂.</li>
      <li data-i18n="p4.12">Evitar la deforestación ilegal.</li>
    </ul></h5>

    <div style="text-align:center; margin: 2px 0;">
     <img class="img"src="Imagenes/La_importancia_de_la_reforestacion.avif" width="350">

  <h4 data-i18n="p4.13"><li>Reducción de Residuos:</li></h4>
    <h5><ul>
      <li data-i18n="p4.14">Reciclar, reutilizar y reducir el consumo de productos desechables.</li>
      <li data-i18n="p4.15">Disminuir el uso de plásticos.</li>
    </ul></h5>

    <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/las_3r.jpg" width="350"> 

  <h4 data-i18n="p4.16"><li>Agricultura Sostenible:</li></h4>
  <h5><ul>
      <li data-i18n="p4.17">Usar técnicas que reduzcan emisiones, como el uso controlado de fertilizantes.</li>
      <li data-i18n="p4.18">Promover dietas con menos carne, ya que la ganadería genera mucho metano.</li>
  </ul></h5>

  <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/omar_imagen3.jpg" width="350">

  <h4 data-i18n="p4.19"><li>Conciencia y Educación Ambiental:</li></h4>
  <h5><ul>
      <li data-i18n="p4.20">Informar y sensibilizar a las personas sobre la importancia de cuidar el planeta.</li>
  </ul></h5>

  <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Conciencia_y_Educación_Ambiental.jpg" width="350">
...
<div style="text-align:center; margin: 20px 0;">
    <video width="330" height="200" controls>
        <source src="Medidas.mp4" type="video/mp4">
...
<h2> Integrante:Espinoza Sanchez Omar</h2>
</footer>  
