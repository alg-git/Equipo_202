...
<h1 data-i18n="p8.19">Cuidado del medio ambiente</h1>  
<h2 data-i18n="p8.1"> Estrategias de Conservación de Flora y Fauna</h2>
...
fetch('traductor_Estrategias_de_Conservación_de_Flora_y_Fauna.json')
...
<li><a data-i18n="m42" href="cerrar.php">Cerrar</a></li>
    ...
    <p data-i18n="p8.5">Para proteger la biodiversidad, se aplican diversas estrategias:</p>

    <ul>
        <li><p data-i18n="p8.6">Creación de áreas naturales protegidas: Reservas, parques nacionales y santuarios que aseguran el hábitat de especies vulnerables.</p></li>

              <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Creación_de_áreas_naturales_protegidas.jpeg" width="600"></div>

        <li><p data-i18n="p8.7">Reforestación y restauración de ecosistemas degradados: Se busca recuperar zonas dañadas y permitir el regreso de flora y fauna nativa.</p></li>

      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Reforestación_y_restauración_de_ecosistemas_degradados.jpg" width="600"></div>

        <li><p data-i18n="p8.8">Educación ambiental para crear conciencia: Informar a la población sobre la importancia de la biodiversidad y cómo protegerla.</p></li>

      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Conciencia_y_Educación_Ambiental.jpg" width="600"></div>

        <li><p data-i18n="p8.9">Uso sostenible de los recursos naturales: Aprovechar los recursos sin agotarlos, permitiendo su regeneración.</p></li>

      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Uso_sostenible_de_los_recursos_naturales.jpg" width="600"></div>

        <li>
            <p data-i18n="p8.10">Leyes y acuerdos internacionales:</p>
            <ul>
                <li data-i18n="p8.11">Convenio sobre la Diversidad Biológica (CDB).</li>

      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Convenio_sobre_la_Diversidad_Biológica_(CDB)..jpeg" width="600"></div>

                <li data-i18n="p8.11b">CITES (Convención sobre el Comercio Internacional de Especies Amenazadas de Fauna y Flora Silvestres).</li>
                
      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/CITES_(Convención_sobre_el_Comercio_Internacional_de_Especies_Amenazadas_de_Fauna_y_Flora_Silvestres)..jpeg" width="600"></div>

                <li data-i18n="p8.11c">Acuerdos regionales y nacionales que protegen hábitats y especies.</li>
            </ul>
        </li>

      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/.jpg" width="600"></div>

        <li><p data-i18n="p8.12">Cría en cautiverio y reintroducción de especies en peligro: Se protege y reproduce a especies amenazadas en entornos controlados antes de reintroducirlas en su hábitat natural.</p></li>

      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Cría_en_cautiverio_y_reintroducción_de_especies_en_peligro.jpg" width="600"></div>

        <li><p data-i18n="p8.13">Control de especies invasoras: Erradicar o controlar especies que amenazan los ecosistemas autóctonos.</p></li>

      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Control_de_especies_invasoras.webp" width="600"></div>

        <li><p data-i18n="p8.14">Turismo sostenible: Fomenta el respeto por la naturaleza y genera ingresos que se reinvierten en conservación.</p></li>

      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Turismo_sostenible.jpeg" width="600"></div>

        <li><p data-i18n="p8.15">Investigación científica para conocer mejor a las especies y sus hábitats: Permite tomar decisiones basadas en evidencia.</p></li>

      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Investigación_científica_para_conocer_mejor_a_las_especies_y_sus_hábitats.avif" width="600"></div>

        <li><p data-i18n="p8.16">Participación comunitaria: Incluir a las comunidades locales en los planes de conservación garantiza mayor compromiso y éxito.</p></li>

      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Participación_comunitaria.jpeg" width="600"></div>

        <li><p data-i18n="p8.17">Monitoreo y vigilancia ambiental: Para detectar amenazas a tiempo y actuar de manera efectiva.</p></li>

      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Monitoreo_y_vigilancia_ambiental.jpg" width="600"></div>

        <li><p data-i18n="p8.18">Restauración de corredores biológicos: Conectar fragmentos de hábitat para que las especies puedan desplazarse y reproducirse.</p></li>
    </ul>

      <div style="text-align:center; margin: 2px 0;">
    <img class="img"src="Imagenes/Restauración_de_corredores_biológicos.png" width="600"></div>

    <iframe width="560" height="315" src="https://www.youtube.com/embed/Xev6_Ra7lis?si=9YtXEL7Vubjor4vX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<h2> Integrantes:Espinoza Sanchez Omar</h2>
